...
public class CreateSDDPage extends LoginPage {
    public CreateSDDPage(WebDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath ="//*[contains(text(),'21:00-23:00')]")
    private WebElement regionalservice;
    ...
    public void createsdd(String pickupaddress , String dropaddress, String sendername, String senderphone, String recievername, String recieverphone) throws InterruptedException {
